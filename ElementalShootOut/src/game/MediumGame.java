...
{        
   ...
   * 
   * @param index - int - Stores the index of the target at the same location as the current inventory element.
   * @param index2 - int - Stores the index of the obstacle at the same location as the current inventory element.
